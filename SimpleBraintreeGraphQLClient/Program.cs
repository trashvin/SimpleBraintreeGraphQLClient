...
{ 
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            //    Console.Write("Enter Form Type (1- Query; 2- Mutation):");
            //    var type = Console.ReadLine();
            //    Console.Write("Enter Query Name :");
            //    var input = Console.ReadLine();

            //    Constants.QUERY_FORM queryType = Int32.Parse(type) == 1 ?
            //        Constants.QUERY_FORM.QUERY :
            //        Constants.QUERY_FORM.MUTATION;


            //    BraintreeQuery pingQuery = new BraintreeQuery(queryType, input);
